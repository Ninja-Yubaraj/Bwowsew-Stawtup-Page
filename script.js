...
function main() {
    ...
    // load user prefs
    if (navigator.onLine) {
        const onlineImageURL = "https://example.com/online-background.jpg";
    
        const img = new Image();
        img.onload = function () {
            body.style.backgroundImage = `url(${onlineImageURL})`;
            generalBackgroundSetting.value = onlineImageURL;
        };
        img.onerror = function () {
            useLocalStorageBackground();
        };
        img.src = onlineImageURL;
    } else {
        useLocalStorageBackground();
    }
    
    function useLocalStorageBackground() {
        if (localStorage.getItem("generalBackground") != null) {
            ...
            body.style.backgroundImage = "url('assets/uwu.png')";
            generalBackgroundSetting.value = "assets/uwu.png";
        }
    }
